...
const HeroCard = () => {
    return (
        <div className="relative w-full max-w-6xl mx-auto rounded overflow-hidden bg-black text-white shadow-2xl border border-neutral-800">
            {/* 
               PERFORMANCE FIX: 
            ...
            */}
            ...
            <div className="relative z-10 p-5 md:p-5 flex flex-col items-center justify-center text-center">
                <p className="w-full max-w-6xl italic text-xl md:text-2xl font-light text-white leading-relaxed">
