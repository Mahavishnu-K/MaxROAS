...
const Contact = () => {
  return (
    ...
    <section className="min-h-screen bg-white flex items-center justify-center px-6 md:px-28 2xl:px-12 py-32">
      <div className="container mx-auto max-w-7xl">
        
        {/* --- LEFT COLUMN: Text & Socials --- */}
        <div className="flex flex-col md:flex-row justify-center md:justify-between h-full w-full">

          {/* Heading */}
          <div>
            <h1 className="text-6xl md:text-8xl text-black font-light mb-6 tracking-tight">
              Let’s Talk
            </h1>
              ...
              <a href="#" className="flex items-center gap-6 group w-fit">
                <div className="transition-transform duration-300 group-hover:scale-110">
                  <Rounded
                      ...
                      className="!p-0 w-20 h-20 bg-white rounded-full border border-gray-200 flex items-center justify-center"
                  >
